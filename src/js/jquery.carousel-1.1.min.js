(function ($) {
    var CarouselEvo = function (element, options) {
        ...
        var slideItems = carousel.children(".slideItem"),
            ...
            pause = true;
        videos = {
            youtube: { reg: /youtube\.com\/watch/i, split: "=", index: 1, url: "http://www.youtube.com/embed/%id%?autoplay=1&amp;fs=1&amp;rel=0" },
            vimeo: { reg: /vimeo\.com/i, split: "/", index: 3, url: "http://player.vimeo.com/video/%id%?portrait=0&amp;autoplay=1" },
        };
        ...
        var initReflection = function () {
            ...
            for (var i = 0; i < n; i++) {
                ...
                $('<div class="reflection"></div>')
                    .css({ position: "absolute", margin: "0", padding: "0", border: "none", overflow: "hidden", left: "0", top: setImageSize(i).height + "px", width: "100%", height: reflectionHeight(i) })
                    .appendTo(items.eq(i))
                    .append(
                        $('<img src="' + src + '" />').css({
                            width: sz.width + "px",
        ...
        var initShadow = function () {
            ...
            for (var i = 0; i < n; i++) {
                ...
                $('<div class="shadow"></div>')
                    .css({ width: sWidth + "px", "z-index": "-1", position: "absolute", margin: "0", padding: "0", border: "none", overflow: "hidden", left: "0", bottom: "0" })
                    .append(sInner)
                    .appendTo(item)
                    .children("div")
        ...
        var animateShadow = function (option, item, i) {
            item.find(".shadow")
                ...
                .animate({ width: shadowMiddleWidth(slidePos(i)) + "px" }, option.speed, "linear");
        };
        ...
        var initSpinner = function () {
            ...
            $('<div class="spinner"></div>')
                ...
                .css({ width: sz.width + "px", height: sz.height + "px", "z-index": numberSlides + 3, position: "absolute", cursor: "pointer", overflow: "hidden", padding: "0", margin: "0", border: "none" })
                .appendTo(carousel);
        };
        var initVideo = function () {
            ...
            $('<div class="videoOverlay"></div>')
                .hide()
                .css(setSlidePosition(0))
                .css({ width: sz.width + "px", height: sz.height + "px", "z-index": numberSlides + 2, position: "absolute", cursor: "pointer", overflow: "hidden", padding: "0", margin: "0", border: "none" })
